...
interface InsightsSectionProps {
  ...
  tirMax: string;
  clienteNome: string;
  /** Um único sistema — sem copy de “recomendado / comparação” */
  modoUnico?: boolean;
}
  ...
  const insights: InsightItem[] = [
    {
      ...
      content: modoUnico
        ? `Com payback de cerca de ${melhorSistemaPayback || paybackMin}, você recupera seu investimento rapidamente, gerando economia pura por mais de 23 anos da vida útil do sistema.`
        : `Com payback entre ${paybackMin} e ${paybackMax} meses, você recupera seu investimento rapidamente, gerando economia pura por mais de 23 anos da vida útil do sistema.`,
    },
    {
      icon: modoUnico ? '☀️' : '🏆',
      title: modoUnico ? 'Sua proposta' : 'Sistema Recomendado',
      content: modoUnico
        ? `O sistema de ${melhorSistemaPotencia} sai por ${melhorSistemaPix} no PIX, com retorno em cerca de ${melhorSistemaPayback} — dimensionado para o seu consumo.`
        : `O ${melhorSistemaNome} de ${melhorSistemaPotencia} possui o melhor payback com ${melhorSistemaPix} no PIX e retorno em apenas ${melhorSistemaPayback}, ideal para maximizar seu investimento.`,
    },
    {
      icon: '⚡',
    ...
    },
    {
      ...
      content:
        'Enquanto a energia elétrica sofre reajustes anuais, seu sistema solar mantém custos fixos, protegendo seu orçamento por décadas.',
    },
    {
      icon: '🔒',
