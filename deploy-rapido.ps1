# PIENG - DEPLOY RAPIDO NETLIFY
# Script simplificado para deploy diario

Write-Host ""
Write-Host "DEPLOY RAPIDO NETLIFY" -ForegroundColor Blue
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "Aguarde alguns minutos para atualizar..." -ForegroundColor Yellow
